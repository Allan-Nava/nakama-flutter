...
final $typed_data.Uint8List authenticateSteamRequestDescriptor = $convert.base64Decode('ChhBdXRoZW50aWNhdGVTdGVhbVJlcXVlc3QSMgoHYWNjb3VudBgBIAEoCzIYLm5ha2FtYS5hcGkuQWNjb3VudFN0ZWFtUgdhY2NvdW50EjIKBmNyZWF0ZRgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5Cb29sVmFsdWVSBmNyZWF0ZRIaCgh1c2VybmFtZRgDIAEoCVIIdXNlcm5hbWU=');
...
final $typed_data.Uint8List linkFacebookRequestDescriptor = $convert.base64Decode('ChNMaW5rRmFjZWJvb2tSZXF1ZXN0EjUKB2FjY291bnQYASABKAsyGy5uYWthbWEuYXBpLkFjY291bnRGYWNlYm9va1IHYWNjb3VudBIuCgRzeW5jGAQgASgLMhouZ29vZ2xlLnByb3RvYnVmLkJvb2xWYWx1ZVIEc3luYw==');
...
final $typed_data.Uint8List sessionDescriptor = $convert.base64Decode('CgdTZXNzaW9uEhgKB2NyZWF0ZWQYASABKAhSB2NyZWF0ZWQSFAoFdG9rZW4YAiABKAlSBXRva2Vu');
...
final $typed_data.Uint8List writeLeaderboardRecordRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List writeTournamentRecordRequestDescriptor = $convert.base64Decode('');
